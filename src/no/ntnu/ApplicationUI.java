...
public class ApplicationUI 
{
    ...
    {  
        ...
        {
            System.out.println("\nERROR: Please provide a number for the amount of pages ..\n");
        }
    ...
    private void printLitteraturInfo(Iterator iterator){
        ...
        if(it.hasNext()){
            while(it.hasNext() ){
                ...
                else if(lit instanceof BookSeries){
                    BookSeries bookSeries = (BookSeries) lit;
